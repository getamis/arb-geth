...
func New(journalPath string, journalTime time.Duration, chainConfig *params.ChainConfig, next *txpool.TxPool, broadcastPendingLocalTxTime time.Duration) *TxTracker {
	pool := &TxTracker{
