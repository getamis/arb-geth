...
func (s *hookedStateDB) GetStylusPagesOpen() uint16 {
	return s.inner.GetStylusPagesOpen()
}
...
func (s *hookedStateDB) CreateZombieIfDeleted(address common.Address) {
	s.inner.CreateZombieIfDeleted(address)
}

func (s *hookedStateDB) FilterTx() {
	s.inner.FilterTx()
}

func (s *hookedStateDB) ClearTxFilter() {
	s.inner.ClearTxFilter()
}
...
func (s *hookedStateDB) Deterministic() bool {
	return s.inner.Deterministic()
}
...
func (s *hookedStateDB) ExpectBalanceBurn(b *big.Int) {
